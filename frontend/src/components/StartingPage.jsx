...
const StartingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Plan trips with friends and family in real-time with live updates",
      icon: "👥",
    ...
    },
    {
      ...
      description:
        "Smart budget tracking and cost optimization for maximum value",
      icon: "💰",
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-yellow-50 to-white relative overflow-hidden">
          ...
          <div ref={heroRef} className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-700 leading-relaxed max-w-lg">
                Transform your travel dreams into reality with our AI-powered
                trip planning platform. Discover, plan, and share unforgettable
                adventures.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="group px-8 py-4 border border-gray-300 text-gray-700 rounded-2xl hover:bg-gray-100 transition-all duration-300 font-semibold text-lg flex items-center justify-center gap-3"
              >
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  {/* Glow effect */}
                  <div
                    className={`absolute -inset-1 bg-gradient-to-r ${stat.color} rounded-2xl blur opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                  ></div>
                </div>
              ))}
            </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-yellow-500 to-yellow-700 bg-clip-text text-transparent mb-4">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-yellow-500 to-yellow-700 bg-clip-text text-transparent mb-4">
                  {feature.title}
                </h3>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-12 py-20 text-center">
        <div className="relative p-12 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 shadow-2xl">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl font-bold bg-gradient-to-r from-yellow-500 to-yellow-700 bg-clip-text text-transparent mb-6">
              Ready to Start Your Journey?
            </h2>
            <p className="text-xl text-black mb-8 max-w-2xl mx-auto">
              Join thousands of travelers who have already discovered the joy of
              seamless trip planning
            </p>

            <Link
              to="/entry"
              className="inline-flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black rounded-2xl hover:from-yellow-500 hover:to-yellow-700 transition-all duration-300 shadow-2xl hover:shadow-yellow-500/25 transform hover:-translate-y-1 font-semibold text-lg"
            >
              Get Started Free
              <FaArrowRight />
            </Link>
